 ...
 */
export function reconstructPublicKey(hdr: Uint8Array, ek: Uint8Array): Uint8Array {
...
export function encaps2(
  ...
  const msg = es.length >= HEADER_SIZE + 32 ? es.slice(HEADER_SIZE, HEADER_SIZE + 32) : undefined;
 ...
 */
export function ekMatchesHeader(ek: Uint8Array, _hdr: Uint8Array): boolean {
