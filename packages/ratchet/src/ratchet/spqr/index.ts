...
import { initA, initB, send as stateSend, recv as stateRecv } from "./states.js";
...
export function initialState(params: SpqrParams): Uint8Array {
  ...
  const inner = params.direction === Direction.A2B ? initA(params.authKey) : initB(params.authKey);
 ...
 */
export function spqrRecv(state: Uint8Array, msg: Uint8Array): SpqrRecvResult {
  // Version negotiation
