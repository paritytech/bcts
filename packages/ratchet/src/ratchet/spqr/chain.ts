...
function hkdfDerive(salt: Uint8Array, ikm: Uint8Array, info: Uint8Array, length: number): Uint8Array {
...
export class Chain {
  ...
  addEpoch(epochSecret: EpochSecret): void {
    ...
    const sendKey =
      this.dir === Direction.A2B ? gen.slice(32, 64) : gen.slice(64, 96);
    const recvKey =
      this.dir === Direction.A2B ? gen.slice(64, 96) : gen.slice(32, 64);
