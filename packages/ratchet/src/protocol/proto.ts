...
export function encodeSignalMessage(msg: SignalMessageProto): Uint8Array {
  ...
  if (msg.previousCounter !== undefined)
    parts.push(encodeUint32(3, msg.previousCounter));
...
export function encodePreKeySignalMessage(
  msg: PreKeySignalMessageProto,
): Uint8Array {
  const parts: Uint8Array[] = [];
  ...
  if (msg.registrationId !== undefined)
    parts.push(encodeUint32(5, msg.registrationId));
  if (msg.signedPreKeyId !== undefined)
    parts.push(encodeUint32(6, msg.signedPreKeyId));
  if (msg.kyberPreKeyId !== undefined)
    parts.push(encodeUint32(7, msg.kyberPreKeyId));
  if (msg.kyberCiphertext)
    parts.push(encodeBytes(8, msg.kyberCiphertext));
...
export function decodePreKeySignalMessage(
  data: Uint8Array,
): PreKeySignalMessageProto {
...
export function encodeSessionStructure(ss: SessionStructureProto): Uint8Array {
  ...
  if (ss.remoteRegistrationId !== undefined) parts.push(encodeUint32Field(10, ss.remoteRegistrationId));
  if (ss.localRegistrationId !== undefined) parts.push(encodeUint32Field(11, ss.localRegistrationId));
  if (ss.aliceBaseKey) parts.push(encodeBytesField(13, ss.aliceBaseKey));
  if (ss.pendingKyberPreKey) parts.push(encodeNestedMessage(14, encodePendingKyberPreKey(ss.pendingKyberPreKey)));
...
export function encodeSenderKeyStateStructure(state: SenderKeyStateStructureProto): Uint8Array {
  ...
  if (state.senderChainKey) parts.push(encodeNestedMessage(2, encodeSenderKeyStateChainKey(state.senderChainKey)));
  if (state.senderSigningKey) parts.push(encodeNestedMessage(3, encodeSenderSigningKey(state.senderSigningKey)));
