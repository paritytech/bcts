...
export type PbChunkedState =
  ...
  | { type: 'headerSent'; uc: PbUnchunkedHeaderSent; sendingEk: PbPolynomialEncoder; receivingCt1: PbPolynomialDecoder }
  | { type: 'ct1Received'; uc: PbUnchunkedCt1Received; sendingEk: PbPolynomialEncoder }
  | { type: 'ekSentCt1Received'; uc: PbUnchunkedEkSentCt1Received; receivingCt2: PbPolynomialDecoder }
  ...
  | { type: 'ct1Sampled'; uc: PbUnchunkedCt1Sampled; sendingCt1: PbPolynomialEncoder; receivingEk: PbPolynomialDecoder }
  | { type: 'ekReceivedCt1Sampled'; uc: PbUnchunkedEkReceivedCt1Sampled; sendingCt1: PbPolynomialEncoder }
