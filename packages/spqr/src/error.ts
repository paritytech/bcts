...
export class EncodingError extends Error {
  constructor(message: string, public readonly inner?: PolynomialError) {
    super(message);
...
export class PolynomialError extends Error {
  constructor(
    message: string,
    public readonly code: 'MESSAGE_LENGTH_EVEN' | 'MESSAGE_LENGTH_TOO_LONG' | 'SERIALIZATION_INVALID',
  ) {
    super(message);
