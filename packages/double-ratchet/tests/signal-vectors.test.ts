...
describe("Signal Test Vectors", () => {
  describe("Chain Key Derivation (keys.rs test_chain_key_derivation)", () => {
    ...
    const expectedCipherKey = "bf51e9d75e0e31031051f82a2491ffc084fa298b7793bd9db620056febf45217";
    ...
    it("should have correct indices", () => {
      ...
      const nextMessageKeys = MessageKeys.deriveFrom(next.messageKeySeed(), next.index);
