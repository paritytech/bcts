 ...
 */
export function x25519RawAgreement(privateKey: Uint8Array, publicKey: Uint8Array): Uint8Array {
  // Reject low-order / torsion public keys
  if (isLowOrderPoint(publicKey)) {
    throw new InvalidKeyError("Invalid public key: low-order / torsion point");
  }
