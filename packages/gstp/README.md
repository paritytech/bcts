...
This TypeScript implementation is based on [gstp-rust](https://github.com/BlockchainCommons/gstp-rust) **v0.13.0** ([commit](https://github.com/BlockchainCommons/gstp-rust/tree/b1296017dd31a6845e1fdbd4ea9a0cad17047eb7)).
