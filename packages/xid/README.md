...
This TypeScript implementation is based on [bc-xid-rust](https://github.com/BlockchainCommons/bc-xid-rust) **v0.23.0** ([commit](https://github.com/BlockchainCommons/bc-xid-rust/tree/e64924eb04e7af3303674663f217768095d73475)).
