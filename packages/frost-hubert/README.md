...
This TypeScript implementation is based on [frost-hubert-rust](https://github.com/BlockchainCommons/frost-hubert-rust) **v0.1.0** ([commit](https://github.com/BlockchainCommons/frost-hubert-rust/tree/f9ec5232d7ebaa6d425e8ff378c5ce0a05900368)).
