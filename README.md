...
| [**lifehash**](packages/lifehash) | LifeHash - visual hash algorithm that generates beautiful, deterministic icons from data using cellular automata. Useful for visual verification of cryptographic hashes and identities. [📖 Docs](https://docs.bcts.dev/api/lifehash) \| [🦀 Rust](https://github.com/BlockchainCommons/bc-lifehash-rust) |
...
| [**lifehash-cli**](tools/lifehash-cli)               | Command-line tool for generating LifeHash visual hash images as PNG files. Create deterministic icons from any input data. [📖 Docs](https://docs.bcts.dev/api/lifehash-cli) \| [🦀 Rust](https://github.com/BlockchainCommons/bc-lifehash-cli-rust) |
